  ...
  lists: {
    "to-do": {
      ...
      items: [
        { id: "1", content: "Kunal" },
        { id: "2", content: "Gaurav" },
        { id: "3", content: "Siwan Bihar" },
        { id: "4", content: "Learning React" },
        { id: "5", content: "Currently face diffuclties with redux" },
      ],
    },
    "in-progress": {
      id: "in-progress",
      title: "In Progress",
      items: [{ id: "6", content: "Hi There This is Kunal Gaurav" }],
    },
    done: {
      id: "done",
      title: "Done",
      items: [
        { id: "7", content: "MERN Stack" },
        {
          id: "8",
          content:
            "Noida",
        },
        { id: "9", content: "ADD, Delete" },
        { id: "10", content: "We can Add any thing like todo" },
      ],
    },
  },
};
